...
def synchronize_data(data):
    ...
    for i in data_list:
        ...
        if not partners.search([('name', '=', i[2]['name'])]):
            ...
            partners.create({'name': i[2]['name'], 'display_name': i[2]['display_name'], 'comment': i[2]['comment']
                             , 'contact_address': i[2]['contact_address'],
                             'email': i[2]['email'],'email_formatted': i[2]['email_formatted'],'email_normalized': i[2]['email_normalized'],
                             'lang': i[2]['lang'], 'phone': i[2]['phone'], 'phone_sanitized': i[2]['phone_sanitized'], 'street': i[2]['street'], 'city': i[2]['city'], 'zip': i[2]['zip'] })
